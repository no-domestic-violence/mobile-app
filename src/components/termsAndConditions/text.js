  ...
  return (
    <View style={styles.textContainer}>
      <Text style={styles.tcP}>
        Placeholder terms and conditions. If you continue to browse and use this
      ...
      <Text style={styles.tcL}>
        ...
        you do allow cookies to be used, the following personal information may
        be stored by us for use by third parties: [insert list of information].
      </Text>
      <Text style={styles.tcL}>
      ...
      <Text style={styles.tcL}>
        ...
        than in accordance with the copyright notice, which forms part of these
      ...
      <Text style={styles.tcL}>
        ...
        use of the website is subject to the laws of England, Northern Ireland,
        Scotland and Wales.
      </Text>
      <Text style={styles.tcP}>
